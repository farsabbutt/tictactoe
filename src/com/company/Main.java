...
public class Main extends JFrame {
    ...
    private void initComponents() {
        ...
        buttonsMap.put("b11", b11);
        buttonsMap.put("b12", b12);
        buttonsMap.put("b13", b13);
        buttonsMap.put("b21", b21);
        buttonsMap.put("b22", b22);
        buttonsMap.put("b23", b23);
        buttonsMap.put("b31", b31);
        buttonsMap.put("b32", b32);
        buttonsMap.put("b33", b33);
    ...
    private void start() {
        int w = 0;
        int turn = 1, current = 1;
        while ((w = getGameStatus(turn, state)) == 0) {

            // first players turn
            if(current == 1){
                    player1.playTurn(1,turn);
                   // refresh the grid.
                refreshGrid();
                current = 2;
        ...
        for(int x=0; x<state.length;x++){
            for(int y=0; y<state.length; y++){
                if(state[x][y] == 1){
                    ...
                    currentButton = (JButton) buttonsMap.get(buttonName);
    ...
    public int getGameStatus(int turn, int[][] st) {
        // check if game is finished and is it draw/win for first player or second.
